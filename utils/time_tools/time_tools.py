...
class TimeTools:
    ...
    def get_current_time(self, fmt: str = __DEFAULT_TIME_FORMAT) -> str:
        """Возвращает текущее время в указанном формате в виде строки."""
        current_datetime = self.get_current_datetime()
        return self.format_datetime_to_str_time(current_datetime, fmt)
    ...
    @staticmethod
    def format_datetime_to_str_time(dt: datetime, fmt: str) -> str:
